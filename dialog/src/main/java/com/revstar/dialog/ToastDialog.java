...
import com.revstar.dialog.common.MyDialogFragment;
...
public final class ToastDialog {
    ...
    public static final class Builder
        ...
        public Builder setType(Type type) {
            ...
            switch (type) {
                case FINISH:
                    mIconView.setImageResource(R.mipmap.notice_clear_finish);
                    break;
                case ERROR:
                    mIconView.setImageResource(R.mipmap.notice_wrong);
                    break;
                case WARN:
                    mIconView.setImageResource(R.mipmap.notice_notice);
                    break;
                default:
                    break;
            }
